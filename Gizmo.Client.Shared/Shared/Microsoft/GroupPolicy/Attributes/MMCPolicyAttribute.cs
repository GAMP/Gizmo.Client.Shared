namespace Microsoft.GroupPolicy
{
    public class MMCPolicyAttribute : PolicyAttribute
    {
        ...
        public MMCPolicyAttribute(string description, string valueName = "", int enableValue = 0, int disabledValue = -1, GroupPolicyTargetOperatingSystem targetOperatingSystem = GroupPolicyTargetOperatingSystem.Windows10and11) 
